...
export default class AdminService implements inAdminService {
  ...
  //   } | null> {
  //     try {
  //       console.log("adminservice mentorStatusChange step1", id, status);

  //     // Do population here using the model
  //     const updateMentor = await (this.BaseRepository as BaseRepository<EMentor>)
  //     .updateField(id, "isApproved", status);
  //     console.log("all users new list>>>>>>>>>>>>>", updateMentor);

  //       console.log("adminservice mentorStatusChange step1", updateMentor);
  ...
  //     try {
  //       console.log("adminservice mentorStatusChange step1", id, status);
  //       const updateMentor = await this.BaseRepository.(
  //         id,
  //         "isBlocked",
  //         status
  //       );
