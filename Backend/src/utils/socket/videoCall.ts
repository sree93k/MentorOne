...
// export const initializeVideoSocket = async (io: Server) => {
...
//     console.log("Redis Pub Client connected (video)")
//   );
//   subClient.on("connect", () =>
//     console.log("Redis Sub Client connected (video)")
//   );
...
//     console.log("Redis adapter for video call connected");
//   } catch (error: any) {
//     console.error("Failed to connect Redis adapter for video:", error.message);
//   }
...
export const initializeVideoSocket = async (videoNamespace: Server) => {
  ...
  videoNamespace.on("connection", (socket: CustomSocket) => {
    ...
    //   // Fix: Use videoNamespace.sockets.sockets.get()
    //   const joinerSocket = videoNamespace.sockets.sockets.get(joinerSocketId);
    //   if (joinerSocket) {
    ...
    //         videoNamespace.sockets.sockets.get(participantSocketId);
