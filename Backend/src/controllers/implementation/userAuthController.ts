...
//   ): Promise<void> => {
//     try {
//       console.log("UserAuthController - sendOTP:", req.body);
...
//       const otpExists = await this.otpServices.checkOTPExists(user);
//       console.log("UserAuthController - OTP exists:", otpExists);
...
//       const createOTP = await this.otpServices.sendOTP(user);
//       console.log("UserAuthController - OTP sent successfully:", createOTP);
...
//         );
//     } catch (error) {
//       console.error("UserAuthController - sendOTP error:", error);
//       next(error);
//     }
//   };
...
//     try {
//       const { email, otp } = req.body;
//       console.log("UserAuthController - createUser for email:", email);
...
//       console.log("UserAuthController - OTP verified, creating user");
//       const userAuthService = DIContainer.getUserAuthService();
//       const signUpData = await userAuthService.createUser(email);
//       console.log("UserAuthController - User created successfully");
...
//         );
//     } catch (error) {
//       console.error("UserAuthController - createUser error:", error);
//       next(error);
//     }
//   };
...
//   ): Promise<void> => {
//     try {
//       console.log("UserAuthController - Login request:", req.body);
//       const userAuthService = DIContainer.getUserAuthService();
//       const loginData = await userAuthService.login(req.body);
//       console.log(
//         "UserAuthController - Login service response:",
//         loginData ? "Success" : "Failed"
//       );
...
//       console.log("UserAuthController - Login successful");
//       res
//         .status(HttpStatus.OK)
//         .json(
//           new ApiResponse(
...
//   ): Promise<void> => {
//     try {
//       console.log("UserAuthController - Google auth step 1");
//       const { firstName, lastName, email, profilePicture } = req.body;
...
//       const userAuthService = DIContainer.getUserAuthService();
//       const userExists = await userAuthService.googleSignIn({ email });
//       console.log(
//         "UserAuthController - Google user exists:",
//         userExists ? "Yes" : "No"
//       );
...
//           maxAge: 20 * 60 * 1000, // 20 minutes
//         });
//         res.cookie("refreshToken", userExists.refreshToken, {
//           httpOnly: true,
//           secure: process.env.NODE_ENV === "production",
//           sameSite: "strict",
//           maxAge: 7 * 24 * 60 * 60 * 1000, // 7 days
...
//         responseType: "arraybuffer",
//       });
//       console.log("UserAuthController - Google auth step 5");
//       const imageBuffer = Buffer.from(response.data, "binary");
//       console.log("UserAuthController - Google auth step 6");

//       const resizedImageBuffer = await sharp(imageBuffer)
//         .resize({ width: 1024 })
//         .jpeg({ quality: 80 })
//         .toBuffer();
//       console.log("UserAuthController - Google auth step 7");
...
//         originalname: `${firstName}_${lastName}_google_profile.jpg`,
//       } as Express.Multer.File);
//       console.log("UserAuthController - Google auth step 8");

//       const userAfterAuth = await userAuthService.googleSignUp({
//         firstName: firstName,
//         lastName: lastName,
//         email: email,
//         profilePicture: fromGoogleImage.url,
//       });
//       console.log("UserAuthController - Google auth step 9");
...
//         maxAge: 20 * 60 * 1000, // 20 minutes
//       });
//       res.cookie("refreshToken", userAfterAuth.refreshToken, {
//         httpOnly: true,
//         secure: process.env.NODE_ENV === "production",
//         sameSite: "strict",
//         maxAge: 7 * 24 * 60 * 60 * 1000, // 7 days
...
//       console.log("UserAuthController - Google authentication successful");
//       res
//         .status(HttpStatus.OK)
//         .json(
//           new ApiResponse(
//             HttpStatus.OK,
//             { userFound: userAfterAuth.user },
//             "Google authentication successful"
//           )
//         );
//     } catch (error) {
...
//   ): Promise<void> => {
//     try {
//       console.log("UserAuthController - forgot password OTP step 1");
//       if (!req.body) {
//         throw new ApiError(HttpStatus.BAD_REQUEST, "Data is required");
//       }
...
//       const isUserExists = await this.userService.findUserWithEmail(req.body);
//       console.log(
//         "UserAuthController - user exists:",
//         isUserExists ? "Yes" : "No"
//       );
...
//       await this.otpServices.sendOTP(req.body);
//       console.log("UserAuthController - forgot password OTP sent");

//       res
//         .status(HttpStatus.OK)
//         .json(new ApiResponse(HttpStatus.OK, null, "OTP sent successfully"));
//     } catch (error) {
//       console.error("UserAuthController - forgotPasswordOTP error:", error);
//       next(error);
//     }
//   };
...
//   ): Promise<void> => {
//     try {
//       console.log("UserAuthController - verify OTP step 1:", req.body);
...
//       );
//       console.log(
//         "UserAuthController - verify OTP step 2:",
//         verifyEmailData ? "Success" : "Failed"
//       );
...
//       console.log("UserAuthController - verifyEmail successful");
//       res
//         .status(HttpStatus.OK)
//         .json(
//           new ApiResponse(
...
//   ): Promise<void> => {
//     try {
//       console.log("UserAuthController - reset password step 1");
...
//       console.log(
//         "UserAuthController - reset password email and password received"
//       );
//       const userAuthService = DIContainer.getUserAuthService();
//       const passwordUpdated = await userAuthService.resetPassword(
//         email,
//         password
//       );
//       console.log(
//         "UserAuthController - password updated:",
//         passwordUpdated ? "Success" : "Failed"
//       );
...
//       console.log("UserAuthController - password reset successful");
//       res
//         .status(HttpStatus.OK)
//         .json(
//           new ApiResponse(HttpStatus.OK, null, "Password reset successful")
...
//   ): Promise<void> => {
//     try {
//       console.log("UserAuthController - logout step 1 - req.user:", req.user);
...
//       const { rawToken, id } = req.user;
//       console.log(
//         "UserAuthController - logout step 2 - rawToken and id received"
//       );

//       const userAuthService = DIContainer.getUserAuthService();
//       const logoutData = await userAuthService.logout(id, rawToken);
//       console.log(
//         "UserAuthController - logout step 3 - logoutData:",
//         logoutData
//       );

//       await this.userService.updateOnlineStatus(id, false, null);
//       console.log("UserAuthController - logout step 4 - online status updated");
...
//   ): Promise<void> => {
//     try {
//       console.log("UserAuthController - refresh token step 1");
...
//       const { rawToken, id } = req.user;
//       console.log(
//         "UserAuthController - refresh token step 2 - user data received"
//       );
...
//       }
//     } catch (error) {
//       console.error("UserAuthController - refresh token error:", error);
...
//   ) => {
//     try {
//       console.log("UserAuthController - validateSuccessResponse step 1");
...
//       });
//     } catch (error) {
//       console.error("UserAuthController - validate session error:", error);
//       res.status(HttpStatus.INTERNAL_SERVER_ERROR).json({
//         success: false,
...
class UserAuthController {
  ...
  public createUser = async (
    ...
    try {
      ...
      console.log("UserAuthController - OTP verified, creating user");
      const userAuthService = DIContainer.getUserAuthService(); // Use DI Container
      const signUpData = await userAuthService.createUser(email);
      console.log("UserAuthController - User created successfully");
