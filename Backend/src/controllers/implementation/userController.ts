...
//       // Skip Socket.IO emit for now until the getIO issue is resolved
//       // TODO: Re-enable when socket utils are fixed
//       console.log("UserController updateOnlineStatus step 3", {
//         userId,
//         isOnline,
//         action: "skipped socket emit (fixing getIO issue)",
//       });
...
import UserService from "../../services/implementations/UserService";
import { createClient } from "@redis/client";
import { getIO } from "../../utils/socket/chat"; // ✅ Now this should work
import { HttpStatus } from "../../constants/HttpStatus";
