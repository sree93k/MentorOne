...
// // initializeVideoSocket Socket.IO
// initializeVideoSocket(httpServer)
//   .then(() => {
//     console.log("Socket.IO initializeVideoSocket initialization complete");
//   })
//   .catch((err) => {
//     console.error(
//       "Socket.IO initializeVideoSocket initialization failed:",
//       err
//     );
//   });
