...
export default class PaymentRepository {
  ...
  //               {
  //                 $lookup: {
  //                   from: "bookings", // Make collection name lowercase (MongoDB convention)
  ...
  //               {
  //                 $lookup: {
  //                   from: "services", // Make collection name lowercase (MongoDB convention)
  ...
  //               {
  //                 $lookup: {
  //                   from: "users", // Make collection name lowercase (MongoDB convention)
  ...
  //                   createdAt: 1,
  //                   serviceName: {
  //                     $ifNull: ["$bookingId.serviceId.title", "Unknown Service"],
  //                   },
  //                   mentorName: {
  //                     $cond: {
  //                       if: {
  ...
  //       // For debugging, log one payment document if available
  ...
  //       return { payments: paymentData, totalAmount, totalCount };
  //     } catch (error: any) {
