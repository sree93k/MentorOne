...
// // Get signed URL for any media file
// mediaRoutes.get(
//   "/signed-url",
...
//       if (!s3Key || typeof s3Key !== "string") {
//         console.log("ERROR: Missing or invalid s3Key");
//         throw new ApiError(HttpStatus.BAD_REQUEST, "S3 key is required");
//       }
...
//       console.log("Final key to check:", key);
...
//       if (!fileExists) {
//         console.log("ERROR: File not found in S3");
//         throw new ApiError(HttpStatus.NOT_FOUND, "File not found in S3");
//       }
...
//   }
// );
// In your mediaRoute.ts, TEMPORARILY comment out the file existence check:
...
//       // TEMPORARILY SKIP FILE EXISTS CHECK
//       // const fileExists = await uploadService.fileExists(key);
//       // if (!fileExists) {
//       //   throw new ApiError(HttpStatus.NOT_FOUND, "File not found in S3");
//       // }
...
//   }
// );
// Enhanced media route with comprehensive debugging
// Temporarily add this route to test without auth
