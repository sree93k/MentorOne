...
//   const notificationCount = notifications.mentorCount;
...
//     // Clear the notification count for mentor role
...
//               <div className="absolute -top-1 -right-1 flex items-center justify-center text-white text-xs font-bold rounded-full min-w-[18px] h-[18px] px-1 bg-red-500 border-2 border-white shadow-lg">
