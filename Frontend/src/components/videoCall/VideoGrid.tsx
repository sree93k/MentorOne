...
//     if (count <= 1) {
//       // Single user: centered, large tile (~70% of viewport width)
//       columns = 1;
...
//       // 2 users: side by side, medium tiles
//       columns = 3;
//       tileStyle = "max-h-[70vw] mx-auto w-full ";
//     } else if (count === 4) {
//       // 3-4 users: 2x2 grid, smaller tiles
//       columns = 2;
//       tileStyle = " max-h-[70vh]  mx-auto";
//     } else if (count <= 6) {
...
//   const { gridCols, tileStyle } = getGridConfig(participants.length);
