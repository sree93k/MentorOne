...
//   return (
//     <div className="flex-1 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 p-4 bg-neutral-900">
...
//   return (
//     <div className="relative bg-neutral-800 rounded-lg overflow-hidden aspect-video flex items-center justify-center">
...
//         />
//       ) : (
//         <div className="w-20 h-20 rounded-full bg-primary-500 flex items-center justify-center text-white text-2xl font-medium uppercase">
...
//           )}
//           {!participant.video && (
//             <VideoOff className="w-4 h-4 text-danger-400" />
//           )}
//         </div>
//       </div>
//     </div>
