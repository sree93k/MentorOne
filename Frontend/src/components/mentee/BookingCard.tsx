...
//     // First, determine the main service type to display
//     let mainType = "";
//     // Account for possible variations in type naming (with or without dash)
...
//     // Then check for additional subtype
//     let subType = "";
//     if (
//       (serviceType === "1-1call" ||
//         serviceType === "11call" ||
...
//             : ""
//         }`}
//         onClick={isDigitalProduct() ? handleCardClick : undefined}
//       >
...
//                 onClick={(e) => {
//                   e.stopPropagation(); // Prevent card click when clicking on profile button
...
//                       size="sm"
//                       onClick={(e) => {
//                         e.stopPropagation(); // Prevent card click when clicking on feedback button
    ...
    <>
      ...
      {isDigitalProduct() && (
        <DigitalProductModal
          isOpen={isDigitalProductModalOpen}
          onClose={() => setIsDigitalProductModalOpen(false)}
          serviceId={booking.serviceId} // Changed from booking.id to booking.serviceId
          title={booking.title}
          productType={booking.digitalProductType || "Document"}
        />
      )}
