...
// //         // Calculate the minimum bookable date based on bookingPeriod
...
// //                   (slot: ScheduleSlot) => slot.isAvailable
// //                 )
// //               ) {
// //                 isAvailable = true;
// //                 break;
...
//         const [schedules, ç] = await Promise.all([
//           getMentorSchedule(service?.slot),
//           getMentorBlockedDates(mentor.userData),
//         ]);
...
//         const bookedSlots = blockedDates
//           .filter((bd: BlockedDate) => bd.type === "booking" && bd.slotTime)
//           .map((bd: BlockedDate) => ({
//             date: new Date(bd.date).toISOString().split("T")[0],
//             slotTime: bd.slotTime,
//           }));
