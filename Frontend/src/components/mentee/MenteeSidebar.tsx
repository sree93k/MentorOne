...
// // import { ProfilePicture, SecureImage } from "@/components/users/SecureMedia";
// // import logo from "@/assets/logo.png";
...
// //         ) : (
// //           <button className="flex items-center justify-center p-2 rounded-lg hover:bg-gray-100 w-full">
// //             {/* Updated: Use SecureImage for logo */}
// //             <SecureImage src={logo} alt="Logo" className="w-full h-auto" />
// //           </button>
// //         )}
// //       </div>
...
// //           <SidebarItem
// //             icon={() => (
// //               /* Updated: Use ProfilePicture component for secure profile image */
// //               <ProfilePicture
...
//         }}
//       >
//         <div>ProfilePicture: {user?.profilePicture || "NULL"}</div>
//         <div>FirstName: {user?.firstName || "NULL"}</div>
//         <div>LastName: {user?.lastName || "NULL"}</div>
//         <div>IsAuthenticated: {String(isAuthenticated)}</div>
//         <div>IsActivated: {String(isActivated)}</div>
//       </div>
//     );
//   };
...
//       {process.env.NODE_ENV === "development" && <DebugUserInfo />}
