...
//   // NEW: Initialize notifications and sync counts
//   useEffect(() => {
...
//     console.log("🔔 Opening notification panel, clearing count for mentee");

//     // Clear the notification count for mentee role
//     dispatch(clearNotificationCount({ role: "mentee" }));

//     // Clear count on server side (optional, for real-time sync)
//     clearNotificationCountForRole("mentee");
...
//           {/* NEW: Enhanced Notification with Badge */}
//           {/* <SidebarItem
//             icon={() => (
//               <NotificationBadge
...
//                 {/* Temporary static count for testing */}
//                 <div className="absolute -top-1 -right-1 flex items-center justify-center text-white text-xs font-bold rounded-full min-w-[18px] h-[18px] px-1 bg-blue-500 border-2 border-white shadow-lg">
...
const MenteeSidebar: React.FC = () => {
  ...
  const openNotification = () => {
    ...
    // Clear the notification count for mentee role (Option A behavior)
    dispatch(clearNotificationCount({ role: "mentee" }));
