...
interface WelcomeModalProps {
  ...
  onSubmit: (data: FormData) => Promise<boolean>; // Returns true if submission succeeds
}
...
export function WelcomeModal({
  ...
  const [step, setStep] = useState(1); // Tracks current form (1 or 2)
  ...
  const handleInputChange = (
    ...
    // Validate string inputs (only allow letters, spaces, and common punctuation)
    if (
      typeof value === "string" &&
  ...
  // Toggle selection for multiple options in form 2
  ...
  // Submit combined form data to backend
  ...
  // Render form for school students
  ...
  // Render form for college students or freshers
  ...
  const renderSecondForm = () => (
    <div className="p-6">
      <div className="space-y-6">
        ...
        {/* Career Goals - Radio Button Style */}
        <div>
