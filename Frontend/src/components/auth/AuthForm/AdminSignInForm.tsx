...
// import { Card, CardContent } from "@/components/ui/card";
// import { Input } from "@/components/ui/input";
// // Import secure image component instead of using regular img tags
// import { SecureImage } from "@/components/users/SecureMedia";
// import LogoImage from "@/assets/logo.png";
// import LogoNameImage from "@/assets/brandlogo.png";
// import SideImage from "@/assets/AdminLogin.jpg";
// import toast, { Toaster } from "react-hot-toast";
...
//         <div className="flex flex-col items-start mb-8 lg:mb-0">
//           <div className="flex items-center mb-8">
//             {/* Updated: Use SecureImage for assets that might be moved to S3 later */}
//             <SecureImage
//               src={LogoImage}
//               alt="Mentor ONE Logo"
//               className="w-[137px] h-[137px] object-cover"
...
import { Card, CardContent } from "@/components/ui/card";
import { Input } from "@/components/ui/input";
// Remove SecureImage import - not needed for static assets
import LogoImage from "@/assets/logo.png";
import LogoNameImage from "@/assets/brandlogo.png";
import SideImage from "@/assets/AdminLogin.jpg";
import toast, { Toaster } from "react-hot-toast";
  ...
  return (
    <main className="relative w-full min-h-screen bg-white bg-cover bg-no-repeat">
      <div className="container mx-auto flex flex-col lg:flex-row items-center justify-between py-12 px-4 bg-white m-20">
        ...
        <div className="flex flex-col items-start mb-8 lg:mb-0">
          <div className="flex items-center mb-8">
            {/* Use regular img tags for static assets - same as LoginForm */}
            <img
              src={LogoImage}
              alt="Mentor ONE Logo"
              className="w-[137px] h-[137px] object-cover"
