...
export function SignupForm({
  ...
  const [errors, setErrors] = useState<TUserSignUpError>({});
      ...
      <div className={cn("flex flex-col gap-6", className)} {...props}>
        <Card className="overflow-hidden">
          <CardContent className="grid p-0 md:grid-cols-2">
            ...
            {/* Use regular img tags for static assets - just like LoginForm */}
      ...
      <EmailVerificationModal
        ...
        onVerify={async (otp) => {
          ...
          try {
            ...
            // ✅ CHANGED: Updated to match new response structure (no tokens)
            const { userFound } = response;
            console.log("response >>>>>r2", userFound);
