...
// import { checkAuthStatus } from "@/utils/auth"; // ✅ ADD THIS IMPORT
// import { markAllNotificationsAsRead } from "../../services/userServices";
// import { useDispatch } from "react-redux";
// import { markAllNotificationsAsRead as markAllAsReadAction } from "@/redux/slices/userSlice";
...
//   // ✅ REMOVE the getCookie function - not needed anymore
//   useEffect(() => {
//     if (currentPage > 1) {
...
//   }, [currentPage]);
//   useEffect(() => {
//     // ✅ FIXED: Use checkAuthStatus instead of checking accessToken cookie
//     const isAuthenticated = checkAuthStatus();
//     console.log(
//       "🔍 Notification component: Authentication check",
//       isAuthenticated
//     );
...
//         const currentRole = window.location.pathname.includes("/expert/")
//           ? "mentor"
//           : "mentee";
...
//       cleanupNotifications();
//     };
//   }, [open, user]); // ✅ Removed accessToken dependency
...
//     try {
//       // Determine current role based on URL or state
//       const currentRole = window.location.pathname.includes("/expert/")
//         ? "mentor"
//         : "mentee";
...
//     }
//   };
//   // ✅ Keep ALL your existing JSX return statement exactly the same
//   return (
