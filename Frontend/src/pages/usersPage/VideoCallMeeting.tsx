...
// import MeetingControls from "@/components/videoCall/MeetingControllers";
...
//   // Set document title
//   useEffect(() => {
//     document.title = `Meeting: ${meetingId} | MeetUp`;
//     return () => {
//       document.title = "MeetUp - Video Conferencing";
//     };
//   }, [meetingId]);
...
//         {/* Floating meeting info button */}
//         <button
//           className="absolute top-4 left-4 w-10 h-10 rounded-full bg-neutral-800/80 flex items-center justify-center text-white hover:bg-neutral-700/80"
...
const VideoCallMeeting: React.FC = () => {
  ...
  return (
    <div className="flex flex-col h-900 bg-gray-900">
