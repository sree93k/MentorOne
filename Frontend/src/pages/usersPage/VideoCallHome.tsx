...
// //         toast({
// //           title: "Success",
// //           description: `Notification sent to ${selectedBooking.menteeId.firstName} with meeting link`,
// //         });
// //         navigate(`/user/meeting/${meetingId}`);
// //       } catch (error: any) {
// //         toast({
...
//   const handleCreateMeeting = async () => {
//     try {
//       console.log("@@@ handleCreateMeeting  STEP 1", bookings);

//       const menteeId = bookings?.menteeId?._id;
