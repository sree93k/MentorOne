...
//   if (loading) {
//     return (
//       <div className="min-h-screen bg-gray-50 dark:bg-gray-900 ml-64 flex items-center justify-center">
...
//                     {message.responses.map((response: any, index: number) => (
//                       <div
//                         key={index}
...
// src/pages/adminPages/adminSubPages/ContactMessageDetail.tsx
import React, { useState, useEffect } from "react";
import { useParams, useNavigate } from "react-router-dom";
import {
  getContactMessage,
              ...
              <CardContent className="space-y-3">
                ...
                {message.phone && (
                  <Button
                    ...
                    className="w-full justify-start"
                    onClick={() =>
                      window.open(`tel:${message.phone}`, "_blank")
                    }
                  >
