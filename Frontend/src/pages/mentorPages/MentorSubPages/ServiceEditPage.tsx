    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 flex justify-center items-center">
        <div className="flex flex-col items-center space-y-4">
          ...
          <p className="text-gray-600 font-medium">Loading service...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="max-w-6xl mx-auto p-6">
        ...
        <div className="flex items-center gap-6 mb-8">
          <Button
            variant="ghost"
            onClick={() => navigate("/expert/services")}
            className="p-3 rounded-full hover:bg-white/60 transition-all duration-200 hover:shadow-md"
          >
          ...
          <div className="flex-1">
            ...
            <p className="text-gray-600">
              Update and manage your service details
            </p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
          {/* 1:1 Call or Priority DM Services */}
          {(service.type === "1-1Call" || service.type === "priorityDM") && (
            <Card className="border-0 shadow-xl bg-white/80 backdrop-blur-sm">
              ...
              <CardContent className="p-8 space-y-8">
                {/* Service Type Selection for 1:1 Call */}
                {service.type === "1-1Call" && (
                  <div className="space-y-4">
                    ...
                    {errors.oneToOneType && (
                      <p className="text-red-500 text-sm flex items-center space-x-2">
                        ...
                        <span>{errors.oneToOneType.message}</span>
                      </p>
                    )}
                  </div>
                )}
                    ...
                    <Controller
                      ...
                      render={({ field }) => (
                        <Textarea
                          placeholder="Brief description of your service"
                          {...field}
                          className="border-gray-200 focus:border-blue-500 focus:ring-blue-500/20 min-h-[120px]"
                        />
                      )}
                    />
                    {errors.shortDescription && (
                ...
                <div className="space-y-2">
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <Textarea
                        placeholder="Provide a comprehensive description of your service, what mentees can expect, and the value they'll receive"
                        className="min-h-[200px] border-gray-200 focus:border-blue-500 focus:ring-blue-500/20"
                        {...field}
                      />
                    )}
                  />
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="space-y-2">
                        ...
                        <Controller
                          ...
                          render={({ field }) => (
                            <Textarea
                              placeholder="Brief description of your document service"
                              {...field}
                              className="border-gray-200 focus:border-emerald-500 focus:ring-emerald-500/20 min-h-[120px]"
                            />
                          )}
                        />
                        {errors.shortDescription && (
                        ...
                        <div className="relative">
                          ...
                          <Controller
                            ...
                            render={({ field }) => (
                              <Input
                                type="number"
                                className="pl-8 border-gray-200 focus:border-emerald-500 focus:ring-emerald-500/20"
                                placeholder="0"
                                {...field}
                                onChange={(e) => {
                                  const value = e.target.value
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="flex items-center gap-4">
                            <Button
                              ...
                              variant="outline"
                              onClick={handleButtonClick}
                              className="bg-emerald-50 border-emerald-200 text-emerald-700 hover:bg-emerald-600 hover:text-white transition-all duration-200"
                            >
                            ...
                            {(selectedFile || service.fileUrl) && (
                              <Button
                                ...
                                variant="outline"
                                onClick={() => setIsPDFModalOpen(true)}
                                className="bg-blue-50 border-blue-200 text-blue-700 hover:bg-blue-600 hover:text-white transition-all duration-200"
                              >
                          ...
                          {errors.pdfFile && (
                            <p className="text-red-500 text-sm flex items-center space-x-1">
                              <AlertCircle className="w-3 h-3" />
                              <span>{errors.pdfFile.message}</span>
                            </p>
                          )}
                        </div>
                      </div>
              ...
              <Card className="border-0 shadow-xl bg-white/80 backdrop-blur-sm">
                <CardHeader className="bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-t-lg">
                  <CardTitle className="flex items-center space-x-2">
                    ...
                    <span>Video Tutorial Service</span>
                  </CardTitle>
                </CardHeader>
                <CardContent className="p-8 space-y-8">
                  {/* Basic Information */}
                    ...
                    <div className="space-y-6">
                      <div className="space-y-2">
                        ...
                        <Controller
                          ...
                          render={({ field }) => (
                            <Input
                              placeholder="Enter tutorial series title"
                              {...field}
                      ...
                      <div className="space-y-2">
                        ...
                        <Controller
                          ...
                          render={({ field }) => (
                            <Textarea
                              placeholder="Brief description of your video tutorial series"
                              {...field}
                              className="border-gray-200 focus:border-purple-500 focus:ring-purple-500/20 min-h-[120px]"
                            />
                          )}
                        />
                        {errors.shortDescription && (
                        ...
                        <div className="relative">
                          ...
                          <Controller
                            ...
                            render={({ field }) => (
                              <Input
                                type="number"
                                className="pl-8 border-gray-200 focus:border-purple-500 focus:ring-purple-500/20"
                                placeholder="0"
                                {...field}
                                onChange={(e) => {
                                  const value = e.target.value
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div className="space-y-4">
                        ...
                        >
                          {exclusiveContent &&
                            ...
                            exclusiveContent.map((season, seasonIndex) => (
                              ...
                              >
                                <AccordionTrigger className="px-4 py-3 hover:bg-purple-50/50 rounded-t-lg">
                                  <div className="flex items-center space-x-3">
                                ...
                                <AccordionContent className="px-4 pb-4">
                                  <div className="space-y-3">
                                    {season.episodes.map((ep, epIndex) => (
                                      <div
                                        key={epIndex}
                                        className="flex justify-between items-start p-3 bg-white/80 rounded-lg border"
                                      >
                          ...
                          {(!exclusiveContent ||
                            ...
                            <div className="text-center py-8 text-gray-500">
                              ...
                              <p className="font-medium">
                                No video episodes added yet
                              </p>
                              <p className="text-sm">
                                Click "Add Video Episode" to get started
                              </p>
                            </div>
                          )}
                        </Accordion>
                      ...
                      {errors.exclusiveContent && (
                        <p className="text-red-500 text-sm flex items-center space-x-1">
                          <AlertCircle className="w-3 h-3" />
                          <span>{errors.exclusiveContent.message}</span>
                        </p>
                      )}
                    </div>
                  </div>
          ...
          <div className="flex gap-6 pt-8">
            <Button
              type="button"
              variant="outline"
              className="flex-1 py-4 text-lg font-semibold border-gray-300 hover:bg-gray-50 transition-all duration-200"
              onClick={() => navigate("/expert/services")}
              disabled={isSubmitting}
            >
              Cancel
            ...
            <Button
              type="submit"
              disabled={isSubmitting}
              className="flex-1 py-4 text-lg font-semibold bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white shadow-lg hover:shadow-xl transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isSubmitting ? (
                <div className="flex items-center space-x-2">
