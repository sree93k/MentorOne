...
//     error,
//   } = useQuery({
//     queryKey: ["mentorPayments", mentorId, page, globalSearch, statusFilter],
//     queryFn: () =>
//       getAllMentorPayments(mentorId!, page, limit, globalSearch, statusFilter),
//     enabled: !!mentorId,
//     select: (data) => ({
...
//         sum + parseFloat(p.amount.replace("₹", "")),
//       0
//     );
